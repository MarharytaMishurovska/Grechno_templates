...
import handmadeImg from './app-info-describe-img/handmade.png';
import priceImg from './app-info-describe-img/price.png';
import qalityImg from './app-info-describe-img/qality.png';
import speedImg from './app-info-describe-img/speed.png';

const AppInfoDescribe = () => {
  return (
...
export default AppInfoDescribe;